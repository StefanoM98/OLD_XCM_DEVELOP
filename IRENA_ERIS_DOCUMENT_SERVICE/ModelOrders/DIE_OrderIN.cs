...
public partial class IOrderIOrdHead
{
    ...
    private string fR_POST_CODEField;
    ...
    private string dEPART_DFROMField;

    private string dEPART_DTOField;
