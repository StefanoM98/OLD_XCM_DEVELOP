...
namespace EzOrdiniRemoti
{
    public class SingleApplication
    {
        ...
        /// <param name="frmMain">main form</param>
        /// <returns>true if no previous instance is running</returns>
        public static bool Run(Type miaclasse)//System.Windows.Forms.Form frmMain)
        {
            if (miaclasse == null) return false;
            ...
            object cl = Activator.CreateInstance(miaclasse);
            Application.Run((Form)cl);
            return true;
        }
