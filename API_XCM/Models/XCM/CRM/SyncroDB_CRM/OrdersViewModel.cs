...
namespace API_XCM.Models.XCM.CRM.SyncroDB_CRM
{
    ...
    public class RootObjectOrderViewModel
    {
        public ResultOrderViewModel result { get; set; }
        public HeaderOrderViewModel header { get; set; }
    }
    ...
    public class HeaderOrderViewModel
    {
