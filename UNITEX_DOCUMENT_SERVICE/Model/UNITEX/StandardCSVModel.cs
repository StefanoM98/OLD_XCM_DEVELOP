...
namespace UNITEX_DOCUMENT_SERVICE.Model.UNITEX
{

    public class UnitexDefaultShipmentHeader
    {
        public string SegmentName { get; set; }  public string ParcelBarcode { get; set; }
